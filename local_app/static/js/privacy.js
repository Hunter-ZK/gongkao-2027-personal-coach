...
const replacements=[
  ...
  ['国家公务员考试','项目A'],['公务员考试','职业项目'],['国考副省级','项目A'],['广东省考','项目B'],['国考','项目A'],['省考','项目B'],['网友红领巾','来源A'],['花生十三','来源B'],['张弓','来源C'],['薛睿','来源D'],['小P','来源E'],
  ['正确答案','参考结果'],['你的答案','当前结果'],['正确率','命中率'],['题库','资料库'],['错题','问题'],['复训','复盘'],['答题','处理'],['做题','处理'],['题目','条目'],['题型','类型'],['作答','记录'],['真题','历史样本'],['模考','模拟任务'],['刷题','批量处理'],['练习','记录'],['答案','结果'],['得分','指标'],['分数','指标'],['上岸','达成目标'],['公务员','岗位'],['考公','工作计划'],['粉笔','来源A'],['训练','记录'],['考试','项目'],['备考','工作'],['公考','个人'],['行测','方法'],['申论','写作']
];
