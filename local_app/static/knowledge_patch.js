...
window.openKnowledge = async function(m,id){
  ...
  const source = d.source_html
    ...
    : `<section class="note-section source-note missing"><h3>个人旧笔记</h3><p>这个节点在现有旧笔记中没有直接对应内容。本页只展示综合方法，后续用真题和高质量公开课程继续补齐。</p></section>`;
