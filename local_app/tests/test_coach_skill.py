...
def test_current_model_and_legacy_alias_are_normalized():
    ...
    assert skill.normalize_model('deepseek-v4-flash-vision-exp') == 'deepseek-flash'
    assert skill.normalize_model('deepseek-chat') == 'deepseek-flash'
    assert skill.normalize_model('deepseek-reasoner') == 'deepseek-flash'
